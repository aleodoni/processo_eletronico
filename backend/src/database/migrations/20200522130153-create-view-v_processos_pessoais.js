...
const viewName = 'spa2.v_processos_pessoais';
...
SELECT a.pro_id,
   ...
   FROM spa2.processo a,
    ...
    spa2.nodo c
  WHERE ((a.tpr_id = b.tpr_id) AND (b.tpr_pessoal = true) AND (a.set_id_finalizador IS NULL) AND (a.usu_finalizador IS NULL) AND (a.nod_id = c.nod_id));
`;
