import FakeDataHoraAtual from '../../app/fakes/models/DataHoraAtualModel';
import FakeAuditoria from '../../app/fakes/models/AuditoriaModel';
import CreateAuditoriaService from '../../app/services/auditoria/CreateAuditoriaService';
...
describe('AuditoriaCreateService', () => {
    ...
    it('Inclusão deve criar duas entradas para a tabela auditoria', async() => {
        await fakeDataHoraAtual.create({ data_hora_atual: new Date() });
