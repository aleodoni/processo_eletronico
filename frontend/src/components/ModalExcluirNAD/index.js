...
const ModalExcluirNAD = props => {
    ...
    const { fechaModalExcluir, modalExcluir, apagaNAD, id } = props;
        ...
        <>
            <Modal
                ...
                <ContainerModal>
                    ...
                    <h1>Deseja excluir a autorização de fornecimento?</h1>
                    <hr />
                    <div>
...
ModalExcluirNAD.propTypes = {
    apagaNAD: PropTypes.func.isRequired,
    fechaModalExcluir: PropTypes.func.isRequired,
    modalExcluir: PropTypes.bool.isRequired,
    id: PropTypes.number,
};

ModalExcluirNAD.defaultProps = {
    id: null,
};

export default ModalExcluirNAD;
